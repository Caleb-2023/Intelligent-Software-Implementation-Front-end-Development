...
export const API_ENDPOINTS = {
  ...
  clothImageUpload: `${API_BASE_URL}/cloths/upload`,
  clothSmartUpload: `${API_BASE_URL}/cloths/smart-upload`,
  clothDetail: `${API_BASE_URL}/cloths/{clothId}`,
  clothIndex: `${API_BASE_URL}/index/garments/{clothId}`,
  clothIndexBatch: `${API_BASE_URL}/index/garments/batch`,
  clothIndexStatus: `${API_BASE_URL}/index/garments/{clothId}/status`,
  tryons: `${API_BASE_URL}/tryons`,
  tryonDetail: `${API_BASE_URL}/tryons/{tryonId}`,
  recommendations: `${API_BASE_URL}/styles/ai-recommend`,
  styles: `${API_BASE_URL}/styles`,
  styleDetail: `${API_BASE_URL}/styles/{styleId}`,
  authLogin: `${API_BASE_URL}/auth/login`,
  authRegister: `${API_BASE_URL}/auth/register`,
  authMe: `${API_BASE_URL}/auth/me`,
  figures: `${API_BASE_URL}/figures`,
  figureUpload: `${API_BASE_URL}/figures/upload`,
  figureDetail: `${API_BASE_URL}/figures/{figureId}`,
  figureGenerateAvatar: `${API_BASE_URL}/figures/{figureId}/generate-avatar`,
  tasks: `${API_BASE_URL}/tasks`,
  taskDetail: `${API_BASE_URL}/tasks/{taskId}`,
  histories: `${API_BASE_URL}/histories`,
  historyDetail: `${API_BASE_URL}/histories/{historyId}`,
  historyFeedback: `${API_BASE_URL}/histories/{historyId}/feedback`,
}
